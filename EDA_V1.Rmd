...
parent_cust_orders <- CustomerInfo %>% 
  ...
  summarize(
            ...
            wellPerformingOutlet2YR = sum(case_when((orderedGallons_2023 +orderedGallons_2024 + orderedCases_2023 + orderedCases_2024) >=400~ 1, TRUE ~ 0)),
...
Things I want to do
- Add an has outlet column - DONE
  - How many outlets perform well - DONE 
- Do proportions in the subgroups - DONE
- Look at if a customer is above threshold compared to their onboarding date - DONE
