...
parent_cust_orders <- CustomerInfo %>% 
  ...
  mutate(targetVariable = case_when(orderedGallons_2023>= 400 ~ 1, orderedGallons_2024>=400 ~ 1,orderedCases_2023>=400 ~ 1, orderedCases_2024>=400 ~1, TRUE ~ 0), 
...
according to the slides, one case = one gallon. So we can make the target ariable looking at both.
